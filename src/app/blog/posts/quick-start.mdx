...
summary: "Magic Portfolio is a comprehensive, MDX-based, SEO-friendly, responsive portfolio template built with Trust Web Ads and Next.js."
...
Magic Portfolio is a comprehensive, MDX-based, SEO-friendly, responsive portfolio template built with Trust Web Ads and Next.js.
...
Subscribe to the [Trust Web Ads Pro plan](https://www.trustwebads.com/pricing) to extend the license to [Dopler CC](https://www.trustwebads.com/products/magic-portfolio).
