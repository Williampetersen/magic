...
summary: "Trust Web Ads is a design system that empowers indie creators, small teams, and startups to build web applications."
images:
...
link: "https://www.trustwebads.com/"
---`,
        language: "tsx",
...
You can use MDX to write the content of your projects. It helps you write rich and dynamic content with minimal code. Some MDX elements will be automatically transformed to Trust Web Ads components to integrate better in the design and add additional functionality.
